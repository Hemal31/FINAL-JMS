...
<head>
	<meta charset="utf-8">
	<title>Jewellery  Management System || Home Page</title>
...
<body>
	...
	<div id="slider">
		<ul>
			<li style="background-image: url(https://images.pexels.com/photos/248077/pexels-photo-248077.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)">
				<h3>Make your life better</h3>
				<h2>Genuine diamonds</h2>
			</li>
			<li class="purple" style="background-image: url(https://images.unsplash.com/photo-1605100804763-247f67b3557e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)">
	...
	<div id="body">
		<div class="container">
			<div class="last-products " >
				<h2 > <strong>Last added products</strong> </h2>
...
<?php } ?>
			...
			<div class="last-products">
				...
				<h2> <strong>Jewellery Categories</strong> </h2>
