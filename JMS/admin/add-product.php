                        ...
                        <div class="card mb-4 p-4">
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    <div >
                                        <div class="col-2" style="font-weight: bold;" style="font-weight: bold;">Category Name</div>
                                        <div class="col-8">
                                    ...
                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Sub Category name</div>
                                    ...
                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Type</div>
                                        <div class="col-8"><select name="type" id="type" class="form-control" required>
                                    ...
                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Product Name</div>
                                        <div class="col-8"><input type="text" name="productName" placeholder="Enter Product Name" class="form-control" required>
                                            </select>
                                        </div>
                                    </div>

                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Product Weight</div>
                                        <div class="col-8"><input type="text" name="productweight" placeholder="Enter Product Weight" class="form-control" required>
                                    ...
                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Product Price After Discount(Selling Price)</div>
                                        <div class="col-8"><input type="text" name="productprice" placeholder="Enter Product Price" class="form-control" required>
                                            </select>
                                        </div>
                                    </div>

                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Product Description</div>
                                        <div class="col-8"><textarea name="productDescription" placeholder="Enter Product Description" rows="6" class="form-control"></textarea>
                                        </div>
                                    </div>

                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Product Shipping Charge</div>
                                        <div class="col-8"><input type="text" name="productShippingcharge" placeholder="Enter Product Shipping Charge" class="form-control" required>
                                            </select>
                                        </div>
                                    </div>

                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Product Availability</div>
                                    ...
                                    <div  style="margin-top:1%;">
                                        ...
                                        <div class="col-8"><select name="gender" id="gender" class="form-control" required>
                                    ...
                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Product Featured Image</div>
                                    ...
                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Product Image 2</div>
                                    ...
                                    <div  style="margin-top:1%;">
                                        <div class="col-2" style="font-weight: bold;">Product Image 3</div>
                                        <div class="col-8"><input type="file" name="productimage3" class="form-control" accept="image/*" title="Accept images only" required>
                                        </div>
                                    </div>

                                    <div class="my-4">
                                        <div class="col-2" style="font-weight: bold;"><button type="submit" name="submit" class="btn btn-primary">Submit</button></div>
                                    </div>
