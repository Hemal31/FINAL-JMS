...
<div class="row">
<div class="col-2" style="font-weight: bold;">Category Name</div>
<div class="col-6">
...
<div class="row my-5 ">
<div class="col-2" style="font-weight: bold;"><button type="submit" name="submit" class="btn btn-primary">Update</button></div>
</div>
